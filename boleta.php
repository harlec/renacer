...
$facturan = 0;
	...
	//obtenemos fecha de la venta (la de la primera si se están uniendo varias)
...
<body class="mobile dashboard">
								...
								<div class="panel panel-default pa">  
									  <div class="panel-body">
									  	<div class="text-center">
									  		<h3>Ventas: <?php echo implode(', ', array_map(function($v){ return 'v-'.$v; }, $venta_ids)); ?><br></h3>
									  	</div>
									    ...
									    <div class="text-center">
									    	<button type="button" data-loading-text="Facturando..." id="facturar" class="btn btn-success btn-lg">Generar Boleta</button>
	...
	$(document ).ready(function() {	
		...
		$( "#ruc" ).change(function() {
			var ruc = $(this).val();
			$.post('/inc/consulta_documento.php', {tipo:'dni', numero: ruc}, function(response){
...
//borrar item
			...
			$("body").on('click', '#facturar', function () {
		    	...
		    	$.ajax({
					...
					error: function(){
						alert('Error de conexión al generar la boleta. Intenta de nuevo.');
						$btn.prop('disabled', false);
					}
				});
