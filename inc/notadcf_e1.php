...
$data = array(
    ...
    "documento_que_se_modifica_serie"   => "FOO3",
    "documento_que_se_modifica_numero"  => 922,
...
if (isset($leer_respuesta['errors'])) {
    ...
    $data = array('id_comprobante'=>'','serie'=>'FC03','numero'=>$leer_respuesta['numero'],'url'=>$leer_respuesta['enlace'],'tipo'=>'F','venta'=>$venta_id,'tipo_doc'=>'6','doc'=>$ruc,'nombre'=>$r_social,'moneda'=>'PEN','tipo_cambio'=>'','grabada'=>$totalg,'igv'=>$totaligv,'total'=>$total,'fecha'=>$fecha,'state'=>'0');
