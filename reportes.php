									...
									<div class="col-md-12">
										<div class="panel panel-default pa">
											<div class="panel-body">
											    <h3 class="">Reporte Stock</h3>
												<div class="row">
													<form action="reportes_f.php" method="post">
														<div class="col-md-2">
															<input type="date" class="form-control" name="fechaini" id="fechaini" value="<?php echo $fecha; ?>" placeholder="Fecha Inicio">
														</div>
														<div class="col-md-2">
