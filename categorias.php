...
foreach ($ventas_list as $value) {
	...
	$datos .='<tr><td>'.$value['id_categoria'].'</td> 
    			<td id ="'.$value['id_categoria'].'" class="nom_cat">'.$value['nom_cat'].'</td> 
    			<td><button class="editar_c btn-custom" alt="editar" value="'.$value['id_categoria'].'"><img src="assets/img/edit.png"/></td> 
    		  </tr>';
    $i++;
}
...
<body class="mobile dashboard">
	<div class="">
		...
		<div class="kbg">
			<div class="cuerpo">
				<div class="titulo">
					<div class="row">
						...
						<div class="col-xs-3">
							<button id="addnew" style="margin-top:6px;" class="btn btn-success">+ Agregar categoría</button>
						</div>
					</div>
			...
			<div class="detalles">
				<div class="titulo-n">
					<h3 id="tituc">Nueva categoría</h3>
				</div>
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
