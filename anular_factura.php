...
$facturan = 0;
	...
	$comprobantes->where('id_comprobante',$id);
	$compro_l = $comprobantes->get_one();

	$ventaid = $compro_l['venta'];

	//obtenemos fecha de la venta
	$venta = Sdba::table('ventas'); // creating table object
	$venta->where('id_venta', $ventaid);
											...
											<div class="panel panel-default pa">  
												  <div class="panel-body">
												  	<div class="text-center">
												  		<h3>Venta <?php echo $ventaid; ?><br><br></h3>
												  	</div>
