...
$producto = $_POST['producto'];
	...
	$ventas1 = Sdba::table('stock'); // creating table object
	$ventas1->where('producto',$producto )->and_where('fecha <=', $fechafin)->and_where('fecha >=',$fechaini);;
							...
							<div class="col-md-12">
								<div class="panel panel-default pa">
									<div class="panel-body table-responsive">
										<h3 class=""><?php echo $name_producto;  ?></h3>
										<table id="datos">
											<thead>
												<tr>
													<th>Id</th> 
