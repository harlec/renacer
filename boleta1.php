...
$facturan = 0;
	...
	foreach ($ventas_list as $key ) {
		...
		$mostrar_de_venta .= '<tr>
								...
								<td><input type="text" name="precio[]" value="'.$key['precio_venta'].'"></td>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="kdashboard">
						<div class="denlaces">
							<a class="enlace" href="venta.php">Registrar venta</a><a class="enlace" href="ventas.php">Listar ventas</a>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default pa">  
									  <div class="panel-body">
									  	<div class="text-center">
									  		<h3>VENTA <?php echo $id; ?> - BOLETA #<?php echo $facturan; ?><br><br></h3>
									  	</div>
									  	<form id="frmfactura" method="post" action="inc/factura_e.php" >
									  		...
									  		<div class="row">
									  			<div class="col-sm-3">
									  				<input class="form-control" type="text" name="placa" id="placa" placeholder="Ingrese placa"><br>
									  			</div>
									  		</div>
									    ...
									    <div class="text-center">
									    	<button data-loading-text="Facturando..." id="facturar" class="btn btn-success btn-lg">Generar Boleta</button>
